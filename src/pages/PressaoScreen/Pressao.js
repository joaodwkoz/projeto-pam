                                ...
                                <ScrollView style={{ width: '100%' }} contentContainerStyle={{ gap: 0.015 * height }} showsVerticalScrollIndicator={false}>
                                    ...
                                    <View style={styles.helpSection}>
                                        ...
                                        <Text style={{
                                            ...
                                            fontSize: 6 * scale,
                                            color: '#8A9CB3',
                                        }}>Monitorar níveis de pressão sistólica e diastólica.</Text>
                                    </View>
                                    ...
                                    <View style={styles.helpSection}>
                                        ...
                                        <Text style={{
                                            ...
                                            fontSize: 6 * scale,
                                            color: '#8A9CB3',
                                        }}>Sistólica, diastólica, data, hora, observações.</Text>
                                    </View>
                                    ...
                                    <View style={styles.helpSection}>
                                        ...
                                        <Text style={{
                                            ...
                                            fontSize: 6 * scale,
                                            color: '#8A9CB3',
                                        }}>Meça sua pressão.</Text>
                                        <Text style={{
                                            fontFamily: 'Poppins-M',
                                            fontSize: 6 * scale,
                                            color: '#8A9CB3',
                                        }}>Registre os valores no app.</Text>
                                    </View>
                                    ...
                                    <View style={styles.helpSection}>
                                        ...
                                        <Text style={{
                                            ...
                                            fontSize: 6 * scale,
                                            color: '#8A9CB3',
                                        }}>Histórico para controle e acompanhamento médico.</Text>
                                    </View>
                                </ScrollView>
                            </Pressable>
                        </Pressable>
